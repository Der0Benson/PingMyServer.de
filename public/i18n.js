    ...
    de: {
      ...
      connections: {
        ...
        team: {
          ...
          summary_owner: "Owner {owner} | {members} Mitglieder | {invitations} offene Einladungen",
          summary_member: "Mitglied im Team von {owner} | {members} Mitglieder",
          summary_none: "Kein aktives Team.",
          setup: {
            title: "Noch kein Team erstellt",
            copy: "Gruende ein Team oder tritt per E-Mail-Einladung bei.",
            create_button: "Team gruenden",
          },
          actions: {
            leave_button: "Team verlassen",
            disband_button: "Team aufloesen",
            confirm_leave: "Willst du dieses Team wirklich verlassen?",
            confirm_disband: "Team wirklich aufloesen? Mitglieder und offene Einladungen werden entfernt.",
          },
          feature: {
            owner_only: "Team gruenden ist aktuell nur fuer den Seiten-Admin freigeschaltet.",
            plan_required: "Team gruenden ist im Pro/Team Abo enthalten (ca. {price} EUR pro Monat).",
          },
          invite: {
          ...
          verify: {
            title: "Teameinladung bestätigen",
            copy: "Gib den Code aus der E-Mail ein und bestätige die Einladung.",
            code_label: "Verifizierungscode",
            code_placeholder: "123456",
            button: "Einladung bestätigen",
          },
          members: {
            title: "Mitglieder",
          ...
          invites: {
            ...
            owner_only_body: "Nur Team-Owner koennen Einladungen verwalten.",
            badge: {
              pending: "Ausstehend",
              expired: "Abgelaufen",
            },
            expires_in: "Läuft ab {expiresIn}",
            expired: "Abgelaufen",
            revoke: "Widerrufen",
            confirm_revoke: "Diese Einladung widerrufen?",
          },
          msg: {
            creating_team: "Team wird gegruendet...",
            create_failed: "Team konnte nicht erstellt werden.",
            create_success: "Team wurde erstellt.",
            already_in_team: "Du bist bereits in einem Team.",
            team_not_created: "Bitte zuerst ein Team gruenden.",
            invite_sending: "Einladung wird gesendet...",
            already_member: "Diese Person ist bereits in deinem Team.",
            already_in_other_team: "Diese Person ist bereits in einem anderen Team.",
            self_invite: "Du kannst deine eigene E-Mail nicht einladen.",
            verification_unavailable: "E-Mail-Verifizierung ist aktuell nicht verfügbar.",
            ...
            invalid_invite_code: "Bitte einen gültigen Verifizierungscode eingeben.",
            verifying: "Einladung wird verifiziert...",
            email_mismatch: "Bitte mit der eingeladenen E-Mail anmelden und erneut bestätigen.",
            invalid_code_with_remaining: "Code ist ungültig. Verbleibende Versuche: {remaining}.",
            ...
            team_membership_conflict: "Verlasse zuerst dein aktuelles Team, bevor du einem neuen Team beitrittst.",
            verify_failed: "Einladung konnte nicht verifiziert werden.",
            verify_success: "Einladung bestätigt. Du bist jetzt im Team.",
            ...
            leaving: "Team wird verlassen...",
            leave_success: "Du hast das Team verlassen.",
            disbanding: "Team wird aufgeloest...",
            disband_success: "Team wurde aufgeloest.",
            leave_failed: "Team-Aktion fehlgeschlagen.",
    ...
    en: {
      ...
      connections: {
        ...
        team: {
          ...
          summary_owner: "Owner {owner} | {members} members | {invitations} open invitations",
          summary_member: "Member in team of {owner} | {members} members",
          summary_none: "No active team.",
          setup: {
            title: "No team created yet",
            copy: "Create a team or join one via email invitation.",
            create_button: "Create team",
          },
          actions: {
            leave_button: "Leave team",
            disband_button: "Disband team",
            confirm_leave: "Do you really want to leave this team?",
            confirm_disband: "Disband this team? Members and open invitations will be removed.",
          },
          feature: {
            owner_only: "Team creation is currently enabled for the site admin only.",
            plan_required: "Team creation is included in the Pro/Team plan (about {price} EUR/month).",
          },
          invite: {
            label: "Invite email",
          ...
          invites: {
            ...
            owner_only_body: "Only team owners can manage invitations.",
            badge: {
              pending: "Pending",
              expired: "Expired",
            },
            expires_in: "Expires {expiresIn}",
            expired: "Expired",
            revoke: "Revoke",
          ...
          msg: {
            ...
            team_membership_conflict: "Leave your current team before joining another one.",
            ...
            leaving: "Leaving team...",
            leave_success: "You left the team.",
            disbanding: "Disbanding team...",
            disband_success: "Team disbanded.",
            leave_failed: "Team action failed.",
