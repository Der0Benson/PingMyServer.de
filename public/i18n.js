  ...
  const STRINGS = {
    de: {
      ...
      port_checker: {
        ...
        lead:
          "PrÃ¼fe kostenlos, ob ein Ã¶ffentlicher TCP-Port auf deiner Domain offen, geschlossen oder nicht erreichbar ist. Ideal fÃ¼r Webserver, Game-Server, Mail-Ports und Firewall-Checks.",
        form: {
          host_label: "Domain oder Hostname",
    ...
    en: {
      ...
      port_checker: {
        ...
        lead:
          "Check for free whether a public TCP port on your domain is open, closed or unreachable. Useful for web servers, game servers, mail ports and firewall checks.",
        form: {
          host_label: "Domain or hostname",
          host_placeholder: "example.com",
          port_label: "Port",
