  ...
  const STRINGS = {
    de: {
      ...
      game_monitor: {
        ...
        mod: {
          title: "Minecraft Mod Verbindung",
          create_pairing: "Verifizierungscode erzeugen",
          sub: "Erstelle einen Pairing-Code im Web und nutze ihn in deiner Mod. Solange der Server läuft und Heartbeats sendet, bleibt die Verbindung online.",
          ...
          sessions_empty_body: "Erzeuge einen Pairing-Code und verbinde deinen Minecraft Mod.",
    ...
    en: {
      ...
      game_monitor: {
        ...
        mod: {
          title: "Minecraft Mod Link",
          create_pairing: "Generate verification code",
          sub: "Generate a pairing code on the web and use it in your mod. As long as the server runs and sends heartbeats, the connection stays online.",
          ...
          sessions_empty_body: "Create a pairing code and connect your Minecraft mod.",
          status_online: "Online",
          status_offline: "Offline",
