  ...
  const STRINGS = {
    de: {
      meta: {
        ...
        landing: {
          title: "PingMyServer – Uptime Monitoring für Websites und HTTP-Dienste",
          description:
            "PingMyServer überwacht Websites und HTTP-Dienste, dokumentiert Ausfälle und informiert per E-Mail, Discord, Slack oder Webhook.",
          og_title: "PingMyServer – Uptime Monitoring",
          og_description: "Überwache Websites und HTTP-Dienste und erfahre, wenn etwas nicht stimmt.",
          twitter_title: "PingMyServer – Uptime Monitoring",
          twitter_description: "Überwache Websites und HTTP-Dienste und erfahre, wenn etwas nicht stimmt.",
        },
        dns_lookup: {
        ...
        port_checker: {
          title: "Port Checker kostenlos | Offene Ports online prÃ¼fen",
      ...
      onboarding: {
        ...
        p2: "oder",
        setup: {
          eyebrow: "MONITOR EINRICHTEN",
          title: "Was sollen wir für dich überwachen?",
          intro: "Lege Ziel, Prüfintervall und Benachrichtigung jetzt fest. Du kannst alles später im Dashboard ändern.",
          target_title: "Ziel auswählen",
          target_help: "Eine öffentliche Website, API oder ein Webdienst auf einer Server-IP.",
          website: "Website oder API",
          website_help: "Domain, URL oder HTTP-Endpunkt",
          server: "Server-IP",
          server_help: "Webdienst über HTTP oder HTTPS",
          game: "Gameserver",
          game_help: "Direkte Port-Checks folgen als Nächstes",
          coming: "In Vorbereitung",
          url: "Domain oder URL",
          url_help: "Ohne Protokoll verwenden wir automatisch HTTPS.",
          server_url: "Server-IP oder URL",
          server_url_help: "Beispiel: http://203.0.113.10:8080 – der Dienst muss öffentlich erreichbar sein.",
          name_help: "So findest du den Monitor später schneller wieder.",
          interval_title: "Wie oft sollen wir prüfen?",
          interval_help: "Kürzere Intervalle erkennen Ausfälle schneller, erzeugen aber mehr Messungen.",
          minute: "Jede Minute",
          minute_help: "Empfohlen für den Start",
          five_minutes: "Alle 5 Minuten",
          five_minutes_help: "Für weniger kritische Seiten",
          fifteen_minutes: "Alle 15 Minuten",
          fifteen_minutes_help: "Für einfache Verfügbarkeit",
          plan_note: "Je nach Tarif stehen später im Dashboard auch schnellere Intervalle zur Verfügung.",
          notify_title: "Wie möchtest du informiert werden?",
          notify_help: "Wir melden uns bei einem Ausfall und erneut, sobald dein Ziel wieder erreichbar ist.",
          email_on: "E-Mail aktivieren",
          email_on_help: "An die E-Mail-Adresse deines Kontos",
          email_off: "Vorerst ohne E-Mail",
          email_off_help: "Später unter Benachrichtigungen aktivierbar",
          more_channels: "Weitere Kanäle wie Discord, Slack oder Webhook verwalten",
          ready: "Bereit zum Start",
          ready_help: "Die erste Messung beginnt direkt nach der Erstellung.",
          create: "Monitor erstellen und starten",
          settings_failed: "Monitor erstellt. Eine gewählte Einstellung konnte nicht gespeichert werden; prüfe sie bitte im Dashboard.",
        },
        label: {
          url: "URL oder Domain",
          name: "Name (optional)",
      ...
      landing: {
        nav: {
          ...
          customers: "Kunden",
          product_items: {
            monitoring_title: "Uptime Monitoring",
            monitoring_desc: "Überwache Websites, APIs und Services rund um die Uhr.",
            incidents_title: "Incident Tracking",
            incidents_desc: "Historie, Ausfallzeiten und Ursachen auf einen Blick.",
            alerting_title: "Alerting & Integrationen",
            alerting_desc: "Discord, E-Mail und Webhooks für sofortige Reaktion.",
            status_title: "Öffentliche Statusseite",
            status_desc: "Live-Transparenz für Nutzer und Kunden.",
          },
          product_side: {
            kpi_title: "Realtime KPI Dashboard",
            kpi_desc: "Response-Zeiten, Uptime und Trends sofort sehen.",
            ssl_title: "Domain & SSL Monitoring",
            ssl_desc: "Ablaufdaten und Zertifikate automatisch überwachen.",
            api_title: "API-Ready Workflows",
            api_desc: "Für Deployments, Ops und Team-Prozesse geeignet.",
          ...
          demo_title: "Demo ansehen",
          demo_desc: "Kurzer Einblick in die Live-Features von PingMyServer.",
          company: "Unternehmen",
          company_about: "Über uns",
          company_about_desc: "Unsere Story und Vision",
          company_github_desc: "Repository und Entwicklung",
          company_commits_desc: "Änderungen live verfolgen",
          company_contact_desc: "Direkt per E-Mail",
          login: "Anmelden",
          dashboard: "Dashboard",
        ...
        proof: {
          history: "Antwortzeiten & Verlauf",
          incidents: "Incident-Historie",
        ...
        story: {
          ...
          stage0: "Ein Ziel. Ein klarer Status.",
          stage1: "Prüfung wird an einen Node gesendet.",
          stage2: "Das Ziel antwortet – oder nicht.",
          stage3: "Messwert und Ereignis werden gespeichert.",
          stage4: "Ein Statuswechsel löst die Meldung aus.",
          steps: {
            add: { title: "Ziel hinzufügen", body: "Website oder HTTP-Endpunkt eintragen und Prüfintervall festlegen." },
            dispatch: { title: "Prüfung ausführen", body: "PingMyServer oder ein freigegebener Community-Node ruft das Ziel ab." },
            measure: { title: "Antwort messen", body: "Statuscode, Antwortzeit und konfigurierte HTTP-Assertions werden ausgewertet." },
            store: { title: "Verlauf speichern", body: "Messwerte, Ausfälle und Wiederherstellungen bleiben nachvollziehbar." },
            alert: { title: "Statuswechsel melden", body: "E-Mail, Discord, Slack oder Webhook informieren dich bei Ausfall und Wiederherstellung." },
          },
        },
        capabilities: {
          kicker: "Produktumfang",
          title: "Monitoring ohne Funktionsnebel.",
          lead: "Nur Funktionen, die du heute tatsächlich verwenden kannst.",
          availability: { title: "Verfügbarkeit", body: "HTTP- und HTTPS-Prüfungen, Statuscodes, Antwortzeiten, Inhaltsprüfungen und Redirect-Kontrolle.", assertions: "Assertions", maintenance: "Wartungen" },
          analysis: { title: "Verlauf & Analyse", body: "Uptime, Antwortzeit, Incident-Verlauf, Tageswerte, SLO und Error-Budget in einer Ansicht." },
          domain: { title: "Domain & Zertifikat", body: "Domainablauf über RDAP und SSL-Zertifikatsdaten direkt im Monitor einsehen.", location: "Standort" },
          notifications: { title: "Benachrichtigungen", body: "Statuswechsel über vier vorhandene Kanäle zustellen und jede Verbindung direkt testen." },
        },
        dashboard: {
          kicker: "Messwerte statt Vermutungen",
          title: "Sehen, was passiert ist – und wann.",
          body: "Das Dashboard verbindet aktuellen Status, Uptime, Antwortzeiten, Incidents, Standorte und SLO in einer nachvollziehbaren Ansicht.",
          link: "Öffentliche Statusseite öffnen ↗",
          caption: "Bestehendes PingMyServer Dashboard",
        },
        community: {
          kicker: "Community-Probes",
          title: "Ein Monitoring-Netzwerk, das mit seiner Community wächst.",
          body: "Ein kleiner Docker-Agent führt freigegebene öffentliche HTTP(S)-Prüfungen aus. Ohne offene Ports und ohne eingehende Verbindung zu deinem Server.",
          security: "Sicherheit", security_value: "signierte, kurzlebige Aufträge",
          trust: "Vertrauen", trust_value: "Trustscore und Referenzprüfungen",
          benefit: "Vorteil", benefit_value: "3 Monitore bei aktiver Connection",
          link: "Technik auf GitHub ansehen ↗",
        },
        tools: {
          kicker: "Ohne Anmeldung",
          title: "Zwei Werkzeuge für den schnellen Check.",
          note: "Einzelprüfungen – kein dauerhaftes Monitoring.",
          dns: "A-, AAAA-, CNAME-, MX-, NS-, SOA-, SRV- und TXT-Records abfragen.",
          port: "Prüfen, ob ein öffentlicher TCP-Port von außen erreichbar ist.",
        },
        live: {
          title: "Live Status",
          ...
          traffic_kicker: "Globale Checks",
          traffic_title: "Traffic aus den USA, Hongkong und Deutschland",
          traffic_badge: "3 aktive Regionen",
          traffic_canvas_label: "Animierter Globus mit aktiven Probe-Regionen",
          traffic_rate: "{count} req/s",
          traffic_nodes: "{count} aktive Nodes",
          traffic_latency: "{ms} ms Median",
          traffic_status: "sendet Live-Traffic",
          traffic_regions: {
            us: "USA / Virginia",
            hk: "Hongkong / Central",
        ...
        rating: {
          ...
          total_many: "{n} Bewertungen",
          average_value: "{value} / 5",
          average_empty: "-- / 5",
          recent_title: "Neueste Rückmeldungen",
          recent_empty: "Noch keine Rückmeldungen.",
          comment_empty: "Ohne Kommentar",
          by_author: "von {author}",
          author_unknown: "User",
          load_failed: "Bewertungen konnten nicht geladen werden.",
          form: {
            label: "Deine Bewertung",
            stars_aria: "Bewertung in Sternen",
            comment_label: "Optionales Feedback",
            comment_placeholder: "Was gefällt dir? Was fehlt dir?",
            open: "Bewertung schreiben",
            hide: "Formular ausblenden",
            submit: "Bewertung senden",
            submitting: "Wird gesendet ...",
            login_required: "Zum Bewerten bitte anmelden.",
            login_cta: "Jetzt anmelden",
          },
          msg: {
            select_rating: "Bitte zuerst Sterne auswählen.",
            saved: "Danke für deine Bewertung!",
            login_required: "Bitte zuerst anmelden.",
            cooldown: "Du hast bereits bewertet. Bitte in {minutes} Minuten erneut versuchen.",
            failed: "Bewertung konnte nicht gesendet werden.",
          },
        },
        features: {
        ...
        pricing: {
          kicker: "Einstieg",
          h2: "Kostenlos anfangen.",
          sub: "Ein Monitor reicht, um PingMyServer mit einem echten Ziel zu testen.",
          plan: "Plan",
          monitors: "Monitore",
          interval: "Kürzestes Intervall",
          raw_data: "Einzelmessungen",
          daily_data: "Tageswerte",
          requirement: "Voraussetzung",
          none: "keine",
          connection: "aktive, vertrauenswürdige Connection",
          no_cc: "Keine Kreditkarte erforderlich.",
          per_month: "/Monat",
          ...
          note: "Community-Connections erhalten 3 kostenlose Monitore und nach Vertrauensprüfung 40 % Abo-Rabatt.",
        },
        faq: {
          h2: "Häufige Fragen",
        ...
        cta: {
          h2: "Dein erster Check dauert weniger als eine Minute.",
          p1: "Ziel hinzufügen, Prüfintervall wählen und Status verfolgen.",
        ...
        footer: {
          pitch: "Uptime Monitoring für Websites und HTTP-Dienste.",
          product: "Produkt",
      ...
      dns_lookup: {
        ...
        form: {
          ...
          host_placeholder: "example.com oder _dmarc.example.com",
          type_label: "Record-Typ",
          submit: "DNS prüfen",
          submitting: "Lookup läuft ...",
          hint: "Du kannst auch eine komplette URL einfügen. Wir verwenden automatisch nur den Hostnamen.",
        },
        examples: {
          label: "Schnelltests",
          domain: "example.com",
        ...
        results: {
          title: "Ergebnis",
          idle: "Starte einen Lookup, um deine DNS-Records zu sehen.",
          loading: "DNS wird abgefragt ...",
          no_records: "Keine passenden Records gefunden.",
          records_one: "{n} Record gefunden",
          records_many: "{n} Records gefunden",
          host: "Host",
          type: "Typ",
          duration: "Antwortzeit",
          code: "Code",
          lookup_failed: "DNS-Lookup fehlgeschlagen. Bitte später erneut versuchen.",
          timeout: "Der DNS-Lookup hat zu lange gebraucht. Bitte erneut versuchen.",
          invalid_host: "Bitte eine gültige Domain oder einen Hostnamen eingeben.",
          invalid_type: "Der gewählte Record-Typ wird nicht unterstützt.",
          value: "Wert",
          priority: "Priorität",
          exchange: "Mailserver",
          weight: "Gewicht",
        ...
        help: {
          ...
          body: "Perfekt für schnelle Checks bei DNS-Propagation, Mail-Setups oder wenn ein externer Service behauptet, dass dein Record noch fehlt.",
          spf: "TXT-Records für SPF, DKIM oder DMARC prüfen",
          mx: "Mailserver und Prioritäten für E-Mail-Setups kontrollieren",
          service: "SRV- oder CNAME-Targets bei Apps und Diensten verifizieren",
        },
        nav: {
          back: "Zur Startseite",
          login: "Login",
      ...
      port_checker: {
        ...
        lead:
          "PrÃ¼fe kostenlos, ob ein Ã¶ffentlicher TCP-Port auf deiner Domain offen, geschlossen oder nicht erreichbar ist. Ideal fÃ¼r Webserver, Mail-Ports und Firewall-Checks.",
        form: {
          host_label: "Domain oder Hostname",
          ...
          submit: "Port prÃ¼fen",
          submitting: "PrÃ¼fung lÃ¤uft ...",
          hint: "Aus SicherheitsgrÃ¼nden sind nur Ã¶ffentliche Ziele erlaubt. Lokale und private Netzwerke sind blockiert.",
        },
        examples: {
          label: "Schnelltests",
          https: "example.com:443",
          mail: "example.com:25",
          game: "play.example.com:25565",
        },
        results: {
          title: "Ergebnis",
          idle: "Starte einen Check, um den Port-Status zu sehen.",
          loading: "Port wird geprÃ¼ft ...",
          status_label: "Status",
          host: "Host",
          port: "Port",
          address: "GeprÃ¼fte IP",
          family: "IP-Version",
          duration: "Antwortzeit",
          reason: "Code",
          open: "Port ist offen",
          ...
          unresolved: "Domain konnte nicht aufgelÃ¶st werden",
          invalid_host: "Bitte eine gÃ¼ltige Domain oder einen Hostnamen eingeben.",
          invalid_port: "Bitte einen gÃ¼ltigen Port zwischen 1 und 65535 eingeben.",
          blocked: "Private oder lokale Ziele sind fÃ¼r dieses Tool gesperrt.",
          failed: "Port-PrÃ¼fung fehlgeschlagen. Bitte spÃ¤ter erneut versuchen.",
        },
        help: {
          title: "WofÃ¼r du es nutzen kannst",
          body: "Perfekt fÃ¼r schnelle Live-Checks, wenn ein Service von auÃŸen erreichbar sein sollte, aber trotzdem nicht antwortet.",
          web: "HTTP-, HTTPS- oder Reverse-Proxy-Ports prÃ¼fen",
          mail: "SMTP-, IMAP- oder andere Mail-Ports von auÃŸen testen",
      ...
      port_checker: {
        ...
        title: "Port Checker kostenlos",
        lead:
          "Prüfe kostenlos, ob ein öffentlicher TCP-Port auf deiner Domain offen, geschlossen oder nicht erreichbar ist. Ideal für Webserver, Mail-Ports und Firewall-Checks.",
        form: {
          host_label: "Domain oder Hostname",
          host_placeholder: "example.com",
          port_label: "Port",
        ...
        reference: {
          ...
          body: "Praktische Standardports für Web, Datenbanken, Mail und Infrastruktur. So siehst du schneller, welcher Port zu deinem Dienst passt.",
          headers: {
            port: "Port",
            service: "Dienst",
      ...
      app: {
        ...
        response: {
          ...
          view_button: "Anzeige",
          view_settings_title: "Chart-Ansicht.",
          view_settings_desc: "Lege fest, ob du einen einzelnen Verlauf oder einen gemeinsamen Mehrlinien-Chart mit allen Probe-Standorten sehen willst.",
          avg: "Durchschnitt",
          p50: "P50 (Median)",
          p95: "P95",
          min: "Minimum",
          max: "Maximum",
          no_data_chart: "Keine Antwortdaten im gewaehlten Zeitraum.",
          ...
          compare_loading: "Standort-Charts werden geladen...",
          compare_empty_title: "Noch keine Standort-Charts verfuegbar.",
          compare_empty_body: "Sobald Probe-Daten verfuegbar sind, erscheinen hier alle Standorte als farbige Linien in einem gemeinsamen Chart.",
          compare_last_check: "Letzter Check: {value}",
          compare_no_probe: "Unbekannter Standort",
          mode: {
            single_title: "Einzel-Chart",
            single_desc: "Ein Verlauf fuer den aktuell gewaehlten Standort oder die Gesamtansicht.",
            compare_title: "Standortvergleich",
            compare_desc: "Alle Probe-Standorte werden als farbige Linien in einem gemeinsamen Chart dargestellt.",
            compare_note: "Im Standortvergleich werden immer alle aktuell verfuegbaren Probe-Standorte zusammen geladen.",
          },
        ...
        incidents: {
          ...
          checks: "Checks: {n}",
          cause_label: "Vermutete Ursache",
          cause: {
            dns: "DNS-Auflösung fehlgeschlagen. Domain- oder DNS-Eintrag prüfen.",
            tls: "TLS/SSL-Handshake fehlgeschlagen. Zertifikat und Hostname prüfen.",
            timeout: "Zeitüberschreitung. Ziel antwortet zu langsam oder gar nicht.",
            network: "Netzwerk- oder Verbindungsproblem. Host und Port prüfen.",
            http_5xx: "Serverfehler (HTTP 5xx) beim Zielsystem.",
            http_4xx: "Anfrage wurde mit HTTP 4xx abgewiesen (oft Auth/Pfad/Firewall).",
            unknown: "Ursache konnte nicht eindeutig bestimmt werden.",
          },
          ongoing: "läuft noch",
          open: "offen",
      ...
      monitors: {
        ...
        email_toggle_enable: "E-Mail-Benachrichtigung für diesen Monitor aktivieren",
        email_toggle_disable: "E-Mail-Benachrichtigung für diesen Monitor deaktivieren",
        email_toggle_enable_aria: "E-Mail-Benachrichtigung für {name} aktivieren",
        email_toggle_disable_aria: "E-Mail-Benachrichtigung für {name} deaktivieren",
        msg_email_saving: "E-Mail-Einstellung wird gespeichert...",
        msg_email_enabled: "E-Mail-Benachrichtigung für Monitor aktiviert.",
        msg_email_disabled: "E-Mail-Benachrichtigung für Monitor deaktiviert.",
      ...
      connections: {
        ...
        app_connections: {
          ...
          connect_hint: "Verwende dieselbe E-Mail-Adresse wie in deinem PingMyServer-Konto.",
          ...
          meta: {
            github_enabled: "GitHub-Login ist für dieses Konto verfügbar.",
            github_disabled: "GitHub-Login ist aktuell deaktiviert.",
      ...
      common: {
        ...
        connections: "Konto & Verbindungen",
        owner_ops: "Owner Ops",
    ...
    en: {
      meta: {
        ...
        landing: {
          title: "PingMyServer – Uptime Monitoring for Websites and HTTP Services",
          description:
            "PingMyServer monitors websites and HTTP services, documents outages and notifies you via email, Discord, Slack or webhook.",
          og_title: "PingMyServer – Uptime Monitoring",
          og_description: "Monitor websites and HTTP services and know when something is wrong.",
          twitter_title: "PingMyServer – Uptime Monitoring",
          twitter_description: "Monitor websites and HTTP services and know when something is wrong.",
        },
        dns_lookup: {
        ...
        port_checker: {
          title: "Free Port Checker | Check Open Ports Online",
          description: "Free port checker: test whether a public TCP port on your domain is reachable or closed.",
        },
        app: {
          title: "Dashboard · PingMyServer",
      ...
      onboarding: {
        ...
        p2: "or",
        setup: {
          eyebrow: "SET UP MONITOR",
          title: "What should we monitor for you?",
          intro: "Choose the target, check interval and notifications now. You can change everything later in the dashboard.",
          target_title: "Choose a target",
          target_help: "A public website, API or web service hosted on a server IP.",
          website: "Website or API",
          website_help: "Domain, URL or HTTP endpoint",
          server: "Server IP",
          server_help: "Web service over HTTP or HTTPS",
          game: "Game server",
          game_help: "Direct port checks are coming next",
          coming: "Coming soon",
          url: "Domain or URL",
          url_help: "Without a protocol, we use HTTPS automatically.",
          server_url: "Server IP or URL",
          server_url_help: "Example: http://203.0.113.10:8080 – the service must be publicly reachable.",
          name_help: "This helps you find the monitor later.",
          interval_title: "How often should we check?",
          interval_help: "Shorter intervals detect outages faster but generate more measurements.",
          minute: "Every minute",
          minute_help: "Recommended for getting started",
          five_minutes: "Every 5 minutes",
          five_minutes_help: "For less critical sites",
          fifteen_minutes: "Every 15 minutes",
          fifteen_minutes_help: "For basic availability",
          plan_note: "Depending on your plan, faster intervals are available later in the dashboard.",
          notify_title: "How should we notify you?",
          notify_help: "We notify you when an outage starts and again when your target is reachable.",
          email_on: "Enable email",
          email_on_help: "Sent to your account email address",
          email_off: "No email for now",
          email_off_help: "Enable it later under Notifications",
          more_channels: "Manage more channels such as Discord, Slack or webhooks",
          ready: "Ready to start",
          ready_help: "The first measurement begins immediately after creation.",
          create: "Create and start monitor",
          settings_failed: "Monitor created. One selected setting could not be saved; please check it in the dashboard.",
        },
        label: {
          url: "URL or domain",
          name: "Name (optional)",
      ...
      landing: {
        nav: {
          ...
          product_items: {
            monitoring_title: "Uptime monitoring",
            monitoring_desc: "Monitor websites, APIs and services around the clock.",
            incidents_title: "Incident tracking",
            incidents_desc: "See history, downtime and root causes at a glance.",
            alerting_title: "Alerting & integrations",
            alerting_desc: "Discord, email and webhooks for fast response.",
            status_title: "Public status page",
            status_desc: "Live transparency for users and customers.",
          },
          product_side: {
            kpi_title: "Realtime KPI dashboard",
            kpi_desc: "See response times, uptime and trends instantly.",
            ssl_title: "Domain & SSL monitoring",
            ssl_desc: "Track expiry dates and certificates automatically.",
            api_title: "API-ready workflows",
            api_desc: "Built for deployments, ops and team processes.",
            dns_title: "DNS lookup tool",
            dns_desc: "Check A, MX, TXT and more records for free.",
            port_title: "Port checker",
            port_desc: "Test whether public TCP ports are reachable from the outside.",
            demo_title: "Live demo",
            demo_desc: "Open the public status page right away.",
          },
          demo_title: "Watch demo",
          demo_desc: "Quick look at PingMyServer live features.",
          company: "Company",
          company_about: "About us",
          company_about_desc: "Our story and mission",
          company_github_desc: "Repository and development",
          company_commits_desc: "Track changes live",
          company_contact_desc: "Reach us by email",
          login: "Sign in",
          dashboard: "Dashboard",
          cta: "Start free",
        },
        ...
        network: { label: "MONITORING NETWORK" },
        proof: {
          history: "Response times & history",
        ...
        story: {
          ...
          title: "What happens during every check.",
          stage0: "One target. One clear status.",
          stage1: "The check is dispatched to a node.",
          stage2: "The target responds – or it does not.",
          stage3: "Measurement and event are stored.",
          stage4: "A status change triggers the notification.",
          steps: {
            add: { title: "Add a target", body: "Enter a website or HTTP endpoint and choose a check interval." },
            dispatch: { title: "Run the check", body: "PingMyServer or an approved community node requests the target." },
            measure: { title: "Measure the response", body: "Status code, response time and configured HTTP assertions are evaluated." },
            store: { title: "Store the history", body: "Measurements, outages and recoveries remain traceable." },
            alert: { title: "Report status changes", body: "Email, Discord, Slack or webhook notify you about outages and recoveries." },
          },
        },
        capabilities: {
          kicker: "Product scope",
          title: "Monitoring without feature fog.",
          lead: "Only features you can actually use today.",
          availability: { title: "Availability", body: "HTTP and HTTPS checks, status codes, response times, content assertions and redirect control.", assertions: "Assertions", maintenance: "Maintenance" },
          analysis: { title: "History & analysis", body: "Uptime, response time, incident history, daily data, SLO and error budget in one view." },
          domain: { title: "Domain & certificate", body: "View domain expiry via RDAP and SSL certificate data directly in the monitor.", location: "Location" },
          notifications: { title: "Notifications", body: "Deliver status changes through four existing channels and test every connection directly." },
        },
        dashboard: {
          kicker: "Measurements, not guesses",
          title: "See what happened – and when.",
          body: "The dashboard combines current status, uptime, response times, incidents, locations and SLO in one traceable view.",
          link: "Open public status page ↗",
          caption: "Existing PingMyServer dashboard",
        },
        community: {
          kicker: "Community probes",
          title: "A monitoring network that grows with its community.",
          body: "A small Docker agent runs approved public HTTP(S) checks, with no open ports and no inbound connection to your server.",
          security: "Security", security_value: "signed, short-lived jobs",
          trust: "Trust", trust_value: "trust score and reference checks",
          benefit: "Benefit", benefit_value: "3 monitors with an active connection",
          link: "View the technology on GitHub ↗",
        },
        tools: {
          kicker: "No account required",
          title: "Two tools for a quick check.",
          note: "One-off checks – not continuous monitoring.",
          dns: "Query A, AAAA, CNAME, MX, NS, SOA, SRV and TXT records.",
          port: "Check whether a public TCP port is reachable from the outside.",
        },
        live: {
          title: "Live Status",
          ...
          traffic_kicker: "Global probes",
          traffic_title: "Traffic from the US, Hong Kong and Germany",
          traffic_badge: "3 active regions",
          traffic_canvas_label: "Animated globe showing active probe regions",
          traffic_rate: "{count} req/s",
          traffic_nodes: "{count} active nodes",
          traffic_latency: "{ms} ms median",
          traffic_status: "sending live traffic",
          traffic_regions: {
            us: "US / Virginia",
            hk: "Hong Kong / Central",
        ...
        rating: {
          ...
          total_one: "{n} rating",
          total_many: "{n} ratings",
          average_value: "{value} / 5",
          average_empty: "-- / 5",
          recent_title: "Latest feedback",
          recent_empty: "No feedback yet.",
          comment_empty: "No comment",
          by_author: "by {author}",
          author_unknown: "User",
          load_failed: "Ratings could not be loaded.",
          form: {
            label: "Your rating",
            stars_aria: "Star rating",
            comment_label: "Optional feedback",
            comment_placeholder: "What do you like? What is missing?",
            open: "Write a review",
            hide: "Hide form",
            submit: "Submit rating",
            submitting: "Submitting ...",
            login_required: "Please sign in to submit a rating.",
            login_cta: "Sign in now",
          },
          msg: {
            select_rating: "Please choose a star rating first.",
            saved: "Thanks for your rating!",
            login_required: "Please sign in first.",
            cooldown: "You already rated. Please try again in {minutes} minutes.",
            failed: "Rating could not be submitted.",
          },
        },
        features: {
        ...
        pricing: {
          kicker: "Get started",
          h2: "Start for free.",
          sub: "One monitor is enough to test PingMyServer with a real target.",
          plan: "Plan",
          monitors: "Monitors",
          interval: "Shortest interval",
          raw_data: "Raw measurements",
          daily_data: "Daily data",
          requirement: "Requirement",
          none: "none",
          connection: "active, trusted connection",
          no_cc: "No credit card required.",
          per_month: "/month",
          ...
          beta: {
            ...
            features: {
              ...
              ssl: "SSL monitoring",
              community: "3 monitors with a live connection",
            },
            cta: "Get beta access",
            no_cc: "No credit card required",
          },
          ...
          note: "Community connections receive 3 free monitors and 40% off a subscription after trust verification.",
        },
        faq: {
          h2: "FAQ",
        ...
        cta: {
          h2: "Your first check takes less than a minute.",
          p1: "Add a target, choose an interval and follow its status.",
        ...
        footer: {
          pitch: "Uptime monitoring for websites and HTTP services.",
          product: "Product",
          dns_lookup: "DNS Lookup",
          port_checker: "Port Checker",
          api_docs: "API Docs",
      ...
      dns_lookup: {
        ...
        form: {
          ...
          host_placeholder: "example.com or _dmarc.example.com",
          type_label: "Record type",
          submit: "Check DNS",
          submitting: "Lookup running ...",
          hint: "You can also paste a full URL. We automatically use only the hostname.",
        },
        examples: {
        ...
        results: {
          title: "Result",
          idle: "Run a lookup to see your DNS records.",
          loading: "Querying DNS ...",
          no_records: "No matching records found.",
          records_one: "{n} record found",
          records_many: "{n} records found",
          host: "Host",
          type: "Type",
          duration: "Response time",
          code: "Code",
          lookup_failed: "DNS lookup failed. Please try again later.",
          timeout: "The DNS lookup took too long. Please try again.",
          invalid_host: "Please enter a valid domain or hostname.",
          invalid_type: "The selected record type is not supported.",
          value: "Value",
          priority: "Priority",
        ...
        help: {
          ...
          body: "Perfect for quick checks during DNS propagation, mail setups, or when an external service says your record is still missing.",
          spf: "Validate TXT records for SPF, DKIM or DMARC",
          mx: "Inspect mail servers and priorities for email setups",
          service: "Verify SRV or CNAME targets for apps and services",
        },
        nav: {
          back: "Back to home",
          login: "Login",
      ...
      port_checker: {
        badge: "Free tool",
        title: "Free Port Checker",
        lead:
          "Check for free whether a public TCP port on your domain is open, closed or unreachable. Useful for web servers, mail ports and firewall checks.",
        form: {
          host_label: "Domain or hostname",
          host_placeholder: "example.com",
          port_label: "Port",
          ...
          submit: "Check port",
          submitting: "Checking ...",
          hint: "For security reasons only public targets are allowed. Local and private networks are blocked.",
        },
        examples: {
          label: "Quick examples",
          https: "example.com:443",
        ...
        results: {
          title: "Result",
          idle: "Run a check to see the port status.",
          loading: "Checking port ...",
          status_label: "Status",
          host: "Host",
          port: "Port",
          address: "Checked IP",
          ...
          timeout: "Port did not answer in time",
          unreachable: "Target is unreachable",
          unresolved: "Domain could not be resolved",
          invalid_host: "Please enter a valid domain or hostname.",
          invalid_port: "Please enter a valid port between 1 and 65535.",
          blocked: "Private or local targets are blocked for this tool.",
          failed: "Port check failed. Please try again later.",
        },
        help: {
          title: "What you can use it for",
          body: "Perfect for quick live checks when a service should be reachable from the internet but still does not answer.",
        ...
        reference: {
          ...
          body: "Practical default ports for web, databases, mail and infrastructure, so you can match a service to the right port faster.",
          headers: {
            port: "Port",
            service: "Service",
            usage: "Common use",
      ...
      app: {
        ...
        response: {
          ...
          last_hour: "Last hour",
          view_button: "View",
          view_settings_title: "Chart view.",
          view_settings_desc: "Choose whether you want one timeline or one shared multi-line chart with all probe locations.",
          avg: "Average",
          p50: "P50 (median)",
          p95: "P95",
          min: "Minimum",
          max: "Maximum",
          no_data_chart: "No response data in the selected window.",
          ...
          compare_loading: "Loading location charts...",
          compare_empty_title: "No location charts available yet.",
          compare_empty_body: "As soon as probe data is available, all locations will appear here as colored lines in one shared chart.",
          compare_last_check: "Last check: {value}",
          compare_no_probe: "Unknown location",
          mode: {
            single_title: "Single chart",
            single_desc: "One timeline for the currently selected location or the aggregate view.",
            compare_title: "Location comparison",
            compare_desc: "All probe locations are displayed together as colored lines in one shared chart.",
            compare_note: "Location comparison always loads all currently available probe locations together.",
          },
        ...
        incidents: {
          ...
          checks: "Checks: {n}",
          cause_label: "Likely cause",
          cause: {
            dns: "DNS resolution failed. Check domain and DNS records.",
            tls: "TLS/SSL handshake failed. Check certificate and hostname.",
            timeout: "Request timed out. Target responded too slowly or not at all.",
            network: "Network or connection issue. Check host and port reachability.",
            http_5xx: "Server-side error (HTTP 5xx) returned by the target.",
            http_4xx: "Request was rejected with HTTP 4xx (often auth/path/firewall).",
            unknown: "Cause could not be determined clearly.",
          },
          ongoing: "ongoing",
          open: "open",
      ...
      connections: {
        ...
        app_connections: {
          ...
          connect_hint: "Use the same email address as in your PingMyServer account.",
          ...
          meta: {
            github_enabled: "GitHub login is available for this account.",
            github_disabled: "GitHub login is currently disabled.",
