    ...
    de: {
      meta: {
        ...
        game_monitor: {
          ...
          description: "Game Monitor für Minecraft: Serverstatus, Ping, Spielerzahlen und weitere Live-Metriken.",
        },
        privacy: {
      ...
      login: {
        ...
        verify: {
          ...
          hint_sent: "Wir haben einen Code an {email} gesendet. Gültig für {seconds} Sekunden.",
        },
        msg: {
          ...
          verification_code_sent: "Verifizierungscode wurde gesendet. Bitte Posteingang prüfen.",
          verification_code_resent: "Verifizierungscode wurde erneut gesendet.",
          verification_unavailable: "Verifizierung ist aktuell nicht verfügbar. Bitte später erneut versuchen.",
          verification_send_failed: "Verifizierungs-E-Mail konnte nicht gesendet werden. Bitte erneut versuchen.",
          verification_throttled: "Zu viele Verifizierungsanfragen. Bitte später erneut versuchen.",
          verifying_code: "Code wird geprüft ...",
          invalid_verification_code: "Bitte gib den {length}-stelligen Verifizierungscode ein.",
          invalid_verification_code_with_remaining: "Code ist ungültig. Verbleibende Versuche: {remaining}.",
          verification_expired: "Verifizierung abgelaufen. Bitte erneut einloggen und neuen Code anfordern.",
          verification_attempts_exceeded: "Zu viele ungültige Codes. Bitte erneut einloggen und neuen Code anfordern.",
          ...
          resend_limit_reached: "Limit für erneutes Senden erreicht. Bitte erneut einloggen.",
      ...
      app: {
        ...
        response: {
          ...
          min: "Minimum",
          max: "Maximum",
          help_button_aria: "Erklaerung zu P-Werten und Chart",
          help_button_title: "Erklaerung anzeigen",
          ...
          help_chart: "Linie = Antwortzeit pro Check. Farbbereiche: gruen < 100 ms, gelb 100-250 ms, rot > 250 ms.",
          help_tooltip: "Mit der Maus ueber die Linie fahren fuer Zeitstempel, Statuscode und Fehler je Messpunkt.",
      ...
      notifications: {
        ...
        sub: "Benachrichtigungskanäle für Statuswechsel deiner Monitore",
        email: {
          ...
          no_recipient: "Kein Empfänger hinterlegt.",
          recipient_configured: "Empfänger konfiguriert.",
          using_account_email: "Es wird deine Konto-E-Mail verwendet.",
          label_address: "Empfänger E-Mail (optional)",
          ...
          msg: {
            ...
            smtp_missing: "SMTP ist nicht konfiguriert.",
            invalid_recipient: "Bitte eine gültige Empfänger E-Mail eingeben.",
            invalid_language: "Bitte eine gültige E-Mail Sprache auswählen.",
        ...
        slack: {
          ...
          msg: {
            loading: "Lade Benachrichtigungen...",
            load_failed: "Einstellungen konnten nicht geladen werden.",
            webhook_required: "Bitte eine gültige Slack Webhook URL eingeben.",
            webhook_required_first: "Bitte zuerst einen Webhook hinzufügen.",
            saving: "Einstellungen werden gespeichert...",
            saved: "Slack Benachrichtigungen gespeichert.",
            save_failed: "Einstellungen konnten nicht gespeichert werden.",
            invalid_webhook: "Ungültige Slack Webhook URL.",
            testing: "Testnachricht wird gesendet...",
            test_sent: "Testnachricht gesendet.",
            test_failed: "Test konnte nicht gesendet werden.",
            removing: "Webhook wird entfernt...",
        ...
        webhook: {
          ...
          msg: {
            loading: "Lade Benachrichtigungen...",
            load_failed: "Einstellungen konnten nicht geladen werden.",
            url_required: "Bitte eine gültige HTTPS Webhook URL eingeben.",
            url_required_first: "Bitte zuerst eine Webhook URL hinzufügen.",
            saving: "Einstellungen werden gespeichert...",
            saved: "Webhook Benachrichtigungen gespeichert.",
            save_failed: "Einstellungen konnten nicht gespeichert werden.",
            invalid_url: "Ungültige Webhook URL.",
      ...
      owner: {
        ...
        email_test: {
          ...
          sub: "Sende eine Test-E-Mail über den konfigurierten SMTP-Account.",
          from: "Von",
          to: "An (Empfänger)",
          template: "E-Mail-Typ",
          ...
          config_security_plain: "Unverschlüsselt",
          config_auth_none: "ohne Login",
          config_auth_user: "Login {user}",
          msg: {
            enter_recipient: "Bitte eine gültige Empfänger-E-Mail eingeben.",
            invalid_template: "Bitte einen gültigen E-Mail-Typ auswählen.",
            sending: "Test-E-Mail wird gesendet...",
            sent: "Test-E-Mail ({template}) gesendet an {to} ({time}).",
            not_configured: "SMTP ist nicht vollständig konfiguriert.",
            invalid_recipient: "Empfänger-Adresse ist ungültig.",
      ...
      game_monitor: {
        ...
        hint_tps: "TPS ist oft nur verfügbar, wenn der Server es aktiv bereitstellt (z. B. per Plugin/RCON).",
        mod: {
        ...
        empty: {
          ...
          body: "Füge deinen ersten Minecraft Server hinzu.",
        },
        state: {
        ...
        metrics: {
          ...
          players: "Spieler",
          version: "Version",
          motd_empty: "Keine MOTD verfügbar.",
          updated: "Aktualisiert",
          sample: "Beispielspieler",
        },
        messages: {
          invalid_address: "Bitte gib einen gültigen Host ein.",
          duplicate: "Server ist bereits in der Liste.",
          limit: "Maximal {count} Server möglich.",
        ...
        error_codes: {
          dns_not_found: "DNS konnte nicht aufgelöst werden.",
          ...
          invalid_status: "Ungültige Statusantwort erhalten.",
          connection_closed: "Verbindung wurde frühzeitig geschlossen.",
          request_failed: "Statusabfrage fehlgeschlagen.",
          connection_failed: "Verbindung fehlgeschlagen.",
          probe_failed: "Server konnte nicht geprüft werden.",
          target_blocked: "Ziel ist aus Sicherheitsgründen blockiert.",
          invalid_input: "Eingabe ist ungültig.",
